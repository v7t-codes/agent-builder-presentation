...
- `http://localhost:8001/presentation.html`

Manual option:

- `python -m http.server 8001`
- Then open `http://localhost:8001/presentation.html`

## Structure

- **One slide = one `*.md` file.**
- **One part = one folder**: `part-0-framing/`, `part-1-market-segments/`, `part-2-summary/`.
